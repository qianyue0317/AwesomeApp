        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mPosition != INVALID_POSITION) {
                    ...
                    // 获取触碰点所在的view
                    mFlingView =
                            (ViewGroup) getChildAt(mPosition - ((LinearLayoutManager) getLayoutManager()).findFirstVisibleItemPosition());
                    ...
                    // 比如使用LinearLayout作为根布局，而content部分width已经是match_parent，此时如果菜单view
                    // 用的是wrap_content，menu的宽度就会为0。
